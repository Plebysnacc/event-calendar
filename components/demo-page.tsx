...
import type { CalendarEvent } from "@/components/event-calendar/lib/types"
import ThemeToggle from "@/components/theme-toggle"

const sampleEventsDefault: CalendarEvent[] = [
  {
    id: "1",
...
const sampleEventsFuture: CalendarEvent[] = [
  {
    id: "10",
    title: "Team Meeting",
    description: "Weekly team sync",
...
export default function DemoPage({
  ...
  const [events, setEvents] = useState<CalendarEvent[]>(
    startOnFirstFutureEvent ? sampleEventsFuture : sampleEventsDefault
  )
  ...
  return (
    ...
    <div className="flex flex-col p-1 sm:p-4 md:p-8">
      <EventCalendar
        ...
        startOnFirstFutureEvent={startOnFirstFutureEvent}
        adminMode={adminMode}
      />
      <div className="mt-4">
        <ThemeToggle />
